//Sdk package from text to speech Api
...
// Dad joke function
const randomDadJokeAPI = async () => {
    const options = {
        method: 'GET',
        headers: {
            'X-RapidAPI-Key': 'f55590a4b3mshb3edd648463bf2ap11e61djsn70aaa2a4ee33',
    ...
    const setup = await data.body[0].setup
    const punchline = await data.body[0].punchline
...
const textToSpeechAPI = async () => {
    ...
    VoiceRSS.speech({
        ...
        key: 'dbe0af2c89f247368370c7cebdef85e8',
        src: await randomDadJokeAPI(),
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
        c: 'mp3',
...
// Add event listener 
document.getElementById("button").onclick = function() {textToSpeechAPI()}
